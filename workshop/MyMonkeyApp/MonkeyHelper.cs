...
public static class MonkeyHelper
{
    ...
    /// <summary>
    /// Gets all monkeys from the static MCP data.
    /// </summary>
    public static async Task<IReadOnlyList<Monkey>> GetMonkeysAsync()
    {
    ...
    public static async Task<Monkey?> GetRandomMonkeyAsync()
    {
        ...
        var selectedMonkey = allMonkeys[random.Next(allMonkeys.Count)];
